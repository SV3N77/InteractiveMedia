class WI {
  ...
  void clearIcon() {
    clear[0] = loadImage("clear/clear3.gif");
    clear[1] = loadImage("clear/clear6.gif");
    clear[2] = loadImage("clear/clear9.gif");
    clear[3] = loadImage("clear/clear12.gif");
    clear[4] = loadImage("clear/clear15.gif");
    clear[5] = loadImage("clear/clear18.gif");
    clear[6] = loadImage("clear/clear21.gif");
    clear[7] = loadImage("clear/clear24.gif");
    clear[8] = loadImage("clear/clear21.gif");
    clear[9] = loadImage("clear/clear18.gif");
    clear[10] = loadImage("clear/clear15.gif");
    clear[11] = loadImage("clear/clear12.gif");
